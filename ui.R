  ...
  dashboardPage(
    ...
    dashboardSidebar(
      sidebarMenu(
        id= "fao",
        menuItem("Start",
                 tabName = "Start",icon = icon("hourglass-start")),
        menuItem("Production",
                 tabName = "production",
    ...
    dashboardBody(
      ...
      tabItems (
        tabItem(tabName = "Start",
                fluidRow(
                  box(title = "Select Country and Year Range", width = 12,
                      status = "primary",
                      solidHeader = TRUE, collapsible = TRUE,
                      selectInput(inputId="countrym49", label="Country",
                                  width = "400px", choices = c("",country_selc)
                      ),
                      ...
                      column(3,
                             div(style="display:inline-block",
                                 actionGroupButtons(
                                   ...
                                   labels=list(tags$span(icon("success"),
                                                         "Start Compilation")),
                      ...
                      div(style="display:inline-block",
                          dropdownButton(
                            ...
                            actionGroupButtons(
                              ...
                              labels = list(
                                tags$span(icon("plus"),
                                          "Upload Livestock Data (Normalized)")
                                ),
                              status = "primary",
                              direction = "vertical"),
                            br(),
                            fileInput("fileLivestockdenormalized",
                            ...
                            downloadButton("downloadLivestock",
                                           "Download Excel file"),
                            circle = FALSE, status = "success",
                            icon = icon("file-excel-o"),
                            tooltip = tooltipOptions(
